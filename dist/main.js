...
const taskManager = (() => {
    ...
    const getTaskEditDetails = function (taskIndex) {
        ...
        const taskObject = inboxTasksArray[taskIndex];
        const formattedDueDate = taskObject.formattedDueDate !== "" ? date_fns__WEBPACK_IMPORTED_MODULE_0__.format(taskObject.formattedDueDate, 'yyyy-MM-dd') : "";
