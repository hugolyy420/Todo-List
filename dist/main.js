...
const taskManager = (() => {
    ...
    const getTodayTasksArray = (array) => array.filter((task) => task.formattedDueDate === date_fns__WEBPACK_IMPORTED_MODULE_0__.format(new Date(), 'dd MMMM yyyy'));
...
const displayController = (() => {
    ...
    function updateTodayTasksDisplay () {
        ...
        const tasksArray = _task__WEBPACK_IMPORTED_MODULE_1__.taskManager.getInboxTaskArray();
        const todayTasksArray = _task__WEBPACK_IMPORTED_MODULE_1__.taskManager.getTodayTasksArray(tasksArray)
    ...
    function updateThisWeekTasksDisplay () {
        ...
        const tasksArray = _task__WEBPACK_IMPORTED_MODULE_1__.taskManager.getInboxTaskArray();
        const thisWeekTasksArray = _task__WEBPACK_IMPORTED_MODULE_1__.taskManager.getThisWeekTasksArray(tasksArray);
