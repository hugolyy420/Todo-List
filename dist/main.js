...
.detail-group{
	display: flex;
	gap: 0.3em;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;CAaC,SAAS;CACT,UAAU;CACV,SAAS;CACT,eAAe;CACf,aAAa;CACb,wBAAwB;AACzB;;AAEA;IACI,kIAAkI;CACrI,aAAa;CACb,+CAA+C;CAC/C,4BAA4B;CAC5B,iBAAiB;CACjB,kBAAkB;AACnB;;AAEA;CACC,kBAAkB;CAClB,yBAAyB;CACzB,WAAW;CACX,iBAAiB;CACjB,cAAc;AACf;;AAEA;CACC,yBAAyB;CACzB,YAAY;AACb;;AAEA;CACC,kBAAkB;AACnB;;AAEA;CACC,yBAAyB;AAC1B;;AAEA;CACC,aAAa;CACb,8BAA8B;AAC/B;;AAEA;CACC,kBAAkB;CAClB,YAAY;CACZ,UAAU;AACX;;AAEA;CACC,YAAY;AACb;;AAEA;CACC,eAAe;AAChB;;AAEA;CACC,aAAa;CACb,iBAAiB;CACjB,cAAc;CACd,QAAQ;CACR,mBAAmB;AACpB;;AAEA;CACC,OAAO;AACR;;AAEA;CACC,eAAe;AAChB;;AAEA;CACC,aAAa;CACb,mBAAmB;CACnB,UAAU;AACX;;AAEA;CACC,OAAO;AACR;;AAEA;CACC,aAAa;CACb,sBAAsB;CACtB,UAAU;AACX;;AAEA;CACC,aAAa;CACb,+BAA+B;CAC/B,yBAAyB;CACzB,YAAY;CACZ,cAAc;CACd,kBAAkB;AACnB;;AAEA;CACC,aAAa;CACb,UAAU;AACX","sourcesContent":["html, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed, \nfigure, figcaption, footer, header, hgroup, \nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n}\n\nbody {\n    font-family: system-ui, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n\tdisplay: grid;\n\tgrid-template-columns: minmax(300px, 0.4fr) 1fr;\n\tgrid-template-rows: auto 1fr;\n\tmin-height: 100vh;\n\tposition: relative;\n}\n\nheader {\n\tgrid-column: 1 / 3;\n\tbackground-color: #606060;\n\tcolor: #fff;\n\tfont-size: 1.5rem;\n\tpadding: 0.6em;\n}\n\n.nav-bar {\n\tbackground-color: #aaaaaa;\n\tpadding: 1em;\n}\n\n.nav-button, .project-tab {\n\tpadding: 0.2em 1em;\n}\n\n.nav-button:hover, .project-tab:hover {\n\tbackground-color: #e1e1e1;\n}\n\n.project-heading {\n\tdisplay: flex;\n\tjustify-content: space-between;\n}\n\n.add-task-button {\n\tposition: absolute;\n\tbottom: 50px;\n\tleft: 50px;\n}\n\n.tasks-display {\n\tpadding: 3em;\n}\n\n.task-display-heading {\n\tfont-size: 2rem;\n}\n\n.task-item {\n\tdisplay: flex;\n\tborder: 1px solid;\n\tpadding: 0.5em;\n\tgap: 1em;\n\tborder-radius: 10px;\n}\n\n.task-title {\n\tflex: 1;\n}\n\n.task-check-button:hover, .task-item:hover {\n\tcursor: pointer;\n}\n\n.project-tab {\n\tdisplay: flex;\n\talign-items: center;\n\tgap: 0.5em;\n}\n\n.project-tab-name {\n\tflex: 1;\n}\n\n.tasks-container {\n\tdisplay: flex;\n\tflex-direction: column;\n\tgap: 0.2em;\n}\n\n.detail-container {\n\tdisplay: grid;\n\tgrid-template-columns: auto 1fr;\n\tborder: 1px solid #aaaaaa;\n\tgap: 1em 5em;\n\tpadding: 0.5em;\n\tborder-radius: 5px;\n}\n\n.detail-group{\n\tdisplay: flex;\n\tgap: 0.3em;\n}"],"sourceRoot":""}]);
// Exports
...
const taskManager = (() => {
    ...
    const updateAllArrays = function () {
        ...
        for (let i = 0; i < inboxTasksArray.length; i++) {
            ...
            if (inboxTasksArray[i].formattedDueDate === date_fns__WEBPACK_IMPORTED_MODULE_0__.format(new Date(), 'dd MMMM yyyy')) {
    ...
    const formateDate = (dueDate) => dueDate === "" ? "" : date_fns__WEBPACK_IMPORTED_MODULE_0__.format(dueDate, 'dd MMMM yyyy');
